    ...
    pub fn visit_literal_expr(&mut self, block: &mut IrBlock, lit: &Literal, span: Span) -> (String, IrType) {
        ...
        match lit {
            Literal::Bool(v) => {
                ...
                block
                    .instructions
                    .push(IrInstruction::assign(result_temp.clone(), IrType::Bool, val, span));
            ...
            Literal::Dec(v) | Literal::Hex(v) | Literal::Bits(v) => {
                ...
                block
                    .instructions
                    .push(IrInstruction::assign(result_temp.clone(), IrType::Int, val, span));
            ...
            Literal::Char(c) => {
                ...
                block
                    .instructions
                    .push(IrInstruction::assign(result_temp.clone(), IrType::Char, val, span));
            ...
            Literal::Str(s) => {
                ...
                block
                    .instructions
                    .push(IrInstruction::assign(result_temp.clone(), IrType::String, val, span));
