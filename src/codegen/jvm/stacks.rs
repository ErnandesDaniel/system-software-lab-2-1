...
impl JvmGenerator {
    ...
    fn instr_stack_delta(instr: &Instruction) -> i32 {
        match instr {
            ...
            | Instruction::Lload(_) | Instruction::Lload_0 | Instruction::Lload_1 | Instruction::Lload_2 | Instruction::Lload_3
            ...
            | Instruction::Iconst_m1 | Instruction::Iconst_0 | Instruction::Iconst_1 | Instruction::Iconst_2
            | Instruction::Iconst_3 | Instruction::Iconst_4 | Instruction::Iconst_5
            | Instruction::Fconst_0 | Instruction::Fconst_1 | Instruction::Fconst_2
            | Instruction::Bipush(_) | Instruction::Sipush(_)
            | Instruction::Ldc(_) | Instruction::Ldc_w(_) | Instruction::Ldc2_w(_)
            | Instruction::Iload(_) | Instruction::Iload_0 | Instruction::Iload_1 | Instruction::Iload_2 | Instruction::Iload_3
            | Instruction::Fload(_) | Instruction::Fload_0 | Instruction::Fload_1 | Instruction::Fload_2 | Instruction::Fload_3
            ...
            Instruction::Lstore(_) | Instruction::Lstore_0 | Instruction::Lstore_1 | Instruction::Lstore_2 | Instruction::Lstore_3
            ...
            | Instruction::Areturn | Instruction::Return => -999,
            Instruction::Istore(_) | Instruction::Istore_0 | Instruction::Istore_1 | Instruction::Istore_2 | Instruction::Istore_3
            | Instruction::Fstore(_) | Instruction::Fstore_0 | Instruction::Fstore_1 | Instruction::Fstore_2 | Instruction::Fstore_3
            ...
            | Instruction::Lcmp | Instruction::Fcmpl | Instruction::Fcmpg | Instruction::Dcmpl | Instruction::Dcmpg
            ...
            | Instruction::Invokevirtual(_) | Instruction::Invokespecial(_) | Instruction::Invokestatic(_)
            | Instruction::Invokeinterface(_, _) | Instruction::Invokedynamic(_)
            | Instruction::Athrow
    ...
    pub(super) fn instr_size(instr: &Instruction) -> usize {
        match instr {
            Instruction::Sipush(_) | Instruction::Iinc(_, _)
            | Instruction::Ifeq(_) | Instruction::Ifne(_) | Instruction::Iflt(_) | Instruction::Ifge(_)
            | Instruction::Ifgt(_) | Instruction::Ifle(_)
            | Instruction::If_icmpeq(_) | Instruction::If_icmpne(_) | Instruction::If_icmplt(_)
            | Instruction::If_icmpge(_) | Instruction::If_icmpgt(_) | Instruction::If_icmple(_)
            ...
            | Instruction::Getstatic(_) | Instruction::Putstatic(_) | Instruction::Getfield(_) | Instruction::Putfield(_)
            | Instruction::Invokevirtual(_) | Instruction::Invokespecial(_) | Instruction::Invokestatic(_)
            | Instruction::New(_) | Instruction::Anewarray(_)
            | Instruction::Checkcast(_) | Instruction::Instanceof(_)
            | Instruction::Ifnull(_) | Instruction::Ifnonnull(_)
            | Instruction::Ldc_w(_) | Instruction::Ldc2_w(_) => 3,
            Instruction::Bipush(_) | Instruction::Ldc(_)
            | Instruction::Ret(_) | Instruction::Newarray(_)
            | Instruction::Iload(_) | Instruction::Lload(_) | Instruction::Fload(_) | Instruction::Dload(_) | Instruction::Aload(_)
            | Instruction::Istore(_) | Instruction::Lstore(_) | Instruction::Fstore(_) | Instruction::Dstore(_) | Instruction::Astore(_) => 2,
            Instruction::Invokeinterface(_, _) | Instruction::Invokedynamic(_) | Instruction::Goto_w(_) | Instruction::Jsr_w(_) => 5,
            _ => 1,
        }
    }
}
