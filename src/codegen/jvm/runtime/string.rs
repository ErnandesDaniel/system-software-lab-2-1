...
impl JvmGenerator {
    pub(super) fn build_string_slice(&mut self, methods: &mut Vec<Method>, code_attr: u16) {
        ...
        methods.push(Method {
            ...
            name_index: ss_name, descriptor_index: ss_desc,
    ...
    pub(super) fn build_printf1(&mut self, methods: &mut Vec<Method>, code_attr: u16, string_class: u16, string_byte_init: u16, str_init_3arg: u16, system_out_ref: u16, print_str_ref: u16, int_to_str: u16, str_replace: u16) {
        ...
        methods.push(Method {
            access_flags: MethodAccessFlags::PUBLIC | MethodAccessFlags::STATIC,
            name_index: printf_name, descriptor_index: printf1_desc,
            attributes: vec![Attribute::Code {
                name_index: code_attr,
    ...
    pub(super) fn build_printf2(&mut self, methods: &mut Vec<Method>, code_attr: u16, string_class: u16, string_byte_init: u16, str_init_3arg: u16, system_out_ref: u16, print_str_ref: u16, int_to_str: u16, str_replace: u16) {
        let printf_name = self.pool.constant_pool.add_utf8("printf").expect("utf8");
        ...
        methods.push(Method {
            access_flags: MethodAccessFlags::PUBLIC | MethodAccessFlags::STATIC,
            name_index: printf_name, descriptor_index: printf2_desc,
            attributes: vec![Attribute::Code {
                name_index: code_attr,
    ...
    pub(super) fn build_printf_methods(&mut self, methods: &mut Vec<Method>, code_attr: u16, string_class: u16, string_byte_init: u16, str_init_3arg: u16, system_out_ref: u16, printstream_class: u16, int_class: u16) {
        let print_str_ref = self.pool.constant_pool.add_method_ref(
            printstream_class, "print", "(Ljava/lang/String;)V",
        ).expect("mref");
        let int_to_str = self.pool.constant_pool.add_method_ref(
            int_class, "toString", "(I)Ljava/lang/String;",
        ).expect("mref");
        let str_replace = self.pool.constant_pool.add_method_ref(
            string_class, "replaceFirst", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;",
        ).expect("mref");
        self.build_printf1(methods, code_attr, string_class, string_byte_init,
            str_init_3arg, system_out_ref, print_str_ref, int_to_str, str_replace);
        self.build_printf2(methods, code_attr, string_class, string_byte_init,
            str_init_3arg, system_out_ref, print_str_ref, int_to_str, str_replace);
    }

    pub(super) fn build_putchar(&mut self, methods: &mut Vec<Method>, code_attr: u16, system_out_ref: u16, print_char_ref: u16) {
        ...
        methods.push(Method {
            ...
            attributes: vec![Attribute::Code {
                name_index: code_attr, max_stack: 2, max_locals: 1,
                code: vec![
                    Instruction::Getstatic(system_out_ref), Instruction::Iload_0,
                    Instruction::I2c, Instruction::Invokevirtual(print_char_ref),
                    Instruction::Iload_0, Instruction::Ireturn,
                ],
    ...
    pub(super) fn build_puts(&mut self, methods: &mut Vec<Method>, code_attr: u16, system_out_ref: u16, string_class: u16, str_init_3arg: u16, println_string_ref: u16) {
        ...
        methods.push(Method {
            ...
            name_index: n, descriptor_index: d,
            attributes: vec![Attribute::Code {
                name_index: code_attr, max_stack: 6, max_locals: 2,
                code: vec![
    ...
    pub(super) fn build_malloc(&mut self, methods: &mut Vec<Method>, code_attr: u16) {
        ...
        methods.push(Method {
            ...
            name_index: n, descriptor_index: d,
            attributes: vec![Attribute::Code {
                name_index: code_attr, max_stack: 1, max_locals: 1,
                code: vec![
                    Instruction::Iload_0,
                    Instruction::Newarray(ristretto_classfile::attributes::ArrayType::Byte),
                    Instruction::Areturn,
    ...
    pub(super) fn build_free(&mut self, methods: &mut Vec<Method>, code_attr: u16) {
        ...
        methods.push(Method {
            ...
            name_index: n, descriptor_index: d,
            attributes: vec![Attribute::Code {
                name_index: code_attr, max_stack: 0, max_locals: 1,
    ...
    pub(super) fn build_atoi(&mut self, methods: &mut Vec<Method>, code_attr: u16, string_class: u16, str_init_3arg: u16, int_parse: u16) {
        ...
        methods.push(Method {
            access_flags: MethodAccessFlags::PUBLIC | MethodAccessFlags::STATIC,
            name_index: atoi_name, descriptor_index: atoi_desc,
            attributes: vec![Attribute::Code {
                name_index: code_attr,
