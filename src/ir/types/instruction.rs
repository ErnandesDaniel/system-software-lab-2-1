...
impl IrInstruction {
    ...
    pub fn str_set_byte(string: IrOperand, index: IrOperand, value: IrOperand, span: Span) -> Self {
        Self {
            ...
            result: None,
            result_type: None,
            operands: vec![string, index, value],
            jump_target: None,
            true_target: None,
            false_target: None,
            span,
