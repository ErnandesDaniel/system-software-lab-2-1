...
#[test]
fn test_exe_putchar() {
    let source = "import putchar def main() { putchar(65); putchar(66); return 0; }";
...
#[test]
fn test_exe_strlen() {
    let source = "import strlen def main() { return strlen(\"hello\"); }";
    let output = compile_and_run(source);
...
fn test_exe_strcmp_eq() {
    let source = "import strcmp def main() { if (strcmp(\"abc\", \"abc\") == 0) { return 1; } else { return 0; } }";
    let output = compile_and_run(source);
...
fn test_exe_strcmp_gt() {
    let source = "import strcmp def main() { if (strcmp(\"b\", \"a\") > 0) { return 1; } else { return 0; } }";
    let output = compile_and_run(source);
...
fn test_exe_strcmp_lt() {
    let source = "import strcmp def main() { if (strcmp(\"a\", \"b\") < 0) { return 1; } else { return 0; } }";
    let output = compile_and_run(source);
...
#[test]
fn test_exe_atoi() {
    let source = "import atoi def main() { return atoi(\"42\"); }";
    let output = compile_and_run(source);
