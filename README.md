...
- Компиляция в нативный исполняемый файл Windows x86-64
- Генерация AST и CFG в формате Mermaid
- Генерация ассемблера NASM x86-64
- Поддержка внешних функций (C runtime)
- Генерация отдельных файлов CFG и ассемблера для каждой функции
- Тестирование с запуском скомпилированных программ
