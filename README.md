...
Нужны - глобальное состояние
и работа программы какое-то время, с возможностью доступа к ней
записать что-то, прочитать, выключить

RPC
JNI наоборот
заменить командную строку на более прямой метод
